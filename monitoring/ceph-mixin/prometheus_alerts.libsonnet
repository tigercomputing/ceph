      ...
      rules: [
        {
          ...
          expr: |||
            (
              predict_linear((avg by (%(cluster)spool_id) (ceph_pool_percent_used))[2d:], 3600 * 24 * 5)
              * on(%(cluster)spool_id) group_right() ceph_pool_metadata
            ) >= 0.95
          ||| % [$.MultiClusterQuery(), $.MultiClusterQuery()],
